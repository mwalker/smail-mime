Gem::Specification.new do |s|
  ...
  s.files         = ["lib/smail/mime.rb", "lib/smail/mime/coding_extensions.rb", "lib/smail/mime/content_extensions.rb", "lib/smail/mime/date.rb", "lib/smail/mime/header.rb", "lib/smail/mime/mime.rb", "lib/smail/mime/version.rb"]
  s.require_path  = "lib"
  s.has_rdoc      = false
